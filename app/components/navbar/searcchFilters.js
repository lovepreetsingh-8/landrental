           ...
           <div className="hidden lg:block">
                <div className="flex flex-row items-center justify-between">
                    <div className="flex flex-row items-center justify-between">
                        ...
                        <div className="cursor-pointer h-[64px] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                            <p className="text-xs font-semibold">Lease start</p>
                            <p className="text-sm">Add dates</p>
                        </div>

                        <div className="cursor-pointer h-[64px] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                            <p className="text-xs font-semibold">Lease end</p>
                            <p className="text-sm">Add dates</p>
                        </div>
                ...
                <div className="p-2">
                    <div className="cursor-pointer p-4 bg-landRental hover:bg-landRentalHover  transition rounded-full text-white">
